package com.onea.viewer.app.data.sd;
...
public final class SDMemoryImageLoader extends ImageLoader {

    private static final String LOG_TAG = SDMemoryImageLoader.class.getName();

    @Override
    public void loadImages() {
        final File directory = new File("/mnt/sdcard2/", Environment.DIRECTORY_DCIM);
        if (directory.exists()) {
